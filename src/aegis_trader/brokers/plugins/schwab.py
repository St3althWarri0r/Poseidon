...
7-day refresh token. Aegis stores both in the vault and refreshes the
...
that step cannot be automated and Aegis will not fake it).
...
``aegis broker schwab-setup`` walks through obtaining all of these.
"""
